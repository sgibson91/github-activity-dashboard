...
queries = {
    ...
    f"is:issue assignee:{username} closed:{month_start}..{month_end}": "closed_last_month",
    f"is:issue author:{username} closed:{month_start}..{month_end}": "closed_last_month",
    f"is:pr assignee:{username} closed:{month_start}..{month_end}": "closed_last_month",
    f"is:pr author:{username} closed:{month_start}..{month_end}": "closed_last_month",
    f"is:issue assignee:{username} closed:{week_start}..{week_end}": "closed_last_week",
    f"is:issue author:{username} closed:{week_start}..{week_end}": "closed_last_week",
    f"is:pr assignee:{username} closed:{week_start}..{week_end}": "closed_last_week",
    f"is:pr author:{username} closed:{week_start}..{week_end}": "closed_last_week",
    f"is:issue assignee:{username} updated:{week_start}..{week_end}": "updated_last_week",
    f"is:issue author:{username} updated:{week_start}..{week_end}": "updated_last_week",
    f"is:pr assignee:{username} updated:{week_start}..{week_end}": "updated_last_week",
    f"is:pr author:{username} updated:{week_start}..{week_end}": "updated_last_week",
}
